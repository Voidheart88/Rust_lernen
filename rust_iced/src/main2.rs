...
// Die Counter Struktur
// Sie Bildet den Zustand des Programms (value) ab und enthält die Buttons
#[derive(Default)]
struct Counter {
    value: i32,
...
// Die verwendeten Messages
// IncrementPressed für den oberen Button
// DecrementPressed für den unteren Button
...
// Die Implementation von Sandbox für die Counter Struktur
// 
impl Sandbox for Counter {
    type Message = Message;

    //Konstruktor für das neue Objekt
    fn new() -> Self {
        Self::default()
    }

    // Diese Funktion wird bei der Konstruktion aufgerufen und bezeichnet den Titel des Fensters
    fn title(&self) -> String {
        String::from("Ein einfacher Zähler")
    }

    // Die Updatefunktion wird aufgerufen wenn eine Message gesendet wurde
    ...
    // Die View Funktion ist für die Anzeige des GUI zuständig.
    // Die Reihenfolge der ".push" Aufrufe ist auch die Reihenfolge in der die GUI-Elemente angezeigt werden 
    fn view(&mut self) -> Element<Message> {
        Column::new()
            .padding(20)
            .push(
                Button::new(&mut self.increment_button, Text::new("+"))
                    .on_press(Message::IncrementPressed),//Legt die Nachricht fest die beim Betätigen des Buttons gesendet wird
            )
            .push(
                Button::new(&mut self.decrement_button, Text::new("-"))
                    .on_press(Message::DecrementPressed),//Legt die Nachricht fest die beim Betätigen des Buttons gesendet wird
            )
